...
function MainPartThree() {
  return (
    ...
    <button className='mt-10 bg-yellow-400  text-[#0281ee] px-14 py-4 rounded-full text-[30px] mx-auto lg:w-[300px] lg:py-4 lg:px-2  hover:bg-[#0281ee] hover:text-yellow-400 border-2 border-yellow-400  text-center lg:mx-0'>ENTER_TERMINAL</button>
    </div>
    </div>
    ...
    <button className='mt-10 bg-[#fc7b01]  text-white px-14 py-4 rounded-full text-[30px] mx-auto lg:w-[300px] lg:py-4 lg:px-2  hover:bg-[#d5d4cf] hover:text-[#fc7b01] border-2 border-[#fc7b01]  text-center lg:mx-0'>ENTER_HANGAR</button>
    <button className='mt-10 bg-[#fc7b01]   text-white px-14 py-4 rounded-full text-[30px] mx-auto lg:w-[300px] lg:py-4 lg:px-2  hover:bg-[#d5d4cf] hover:text-[#fc7b01] border-2 border-[#fc7b01] text-center lg:mx-0'>GO_FOR_A_HUNT</button>
    </div>
    </div>
    </div>
